...
async def shutdown_bot(event):
    ...
    if BOTLOG_CHATID:
        await event.client.send_message(
            BOTLOG_CHATID,
            "**#SHUTDOWN** \n"
            "**xMan-Userbot** telah di matikan!\nJika ingin menghidupkan kembali silahkan buka heroku",
        )
    await edit_or_reply(event, "**xMan-Userbot Berhasil di matikan!**")
...
async def restart_bot(event):
    ...
    if BOTLOG_CHATID:
        await event.client.send_message(
            BOTLOG_CHATID, "#RESTART \n" "**xMan-Userbot Berhasil Di Restart**"
        )
...
async def reedme(event):
    await edit_or_reply(
        ...
        "\n✣ [Userbot Repo](https://github.com/muhammadhanif71/xMan-Userbot/blob/Man-Userbot/README.md)"
        "\n✣ [Video Tutorial](https://youtu.be/tTDaPKsGC1I)"
        "\n✣ [List Variabel Heroku untuk xMan-Userbot](https://telegra.ph/List-Variabel-Heroku-untuk-Man-Userbot-09-22)"
...
async def repo_is_here(event):
    ...
    await xx.edit(
        ...
        f"✣ **Channel xMan :** [Stuf Channel](t.me/stufchannel)\n"
